    ...
    return(
        <div className = 'sponsor-page'>
            ...
            <div className = 'spon-grid-1'>
                ...
                <div className = 'spon-logos'><a href="https://www.fabheads.in"><img src = {Fabheads}></img></a></div>
                <div className = 'spon-logos'><a href="https://www.loanswall.com"><img src = {Loanswall}></img></a></div>
            ...
            <div className = 'spon-grid-2'>
                ...
                <div className = 'star-spon-logo'><a href="https://www.starlabsurat.com"><img src= {Starlabs}/></a></div>
                </Zoom>
            </div>
            <br/><br/><br/><br/><br/><br/>
